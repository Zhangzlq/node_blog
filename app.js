...
//Technology!
app.get("/Technology", router.showTechnology);
app.post("/getTechnology", router.getTechnology);
//Technology

//Entertainment!
app.get("/Entertainment", router.showEntertainment);
app.post("/getEntertainment", router.getEntertainment);
//Entertainment
