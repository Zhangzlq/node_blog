...
//Technology!
exports.showTechnology = function (req, res, result) {
    res.render("Technology");
};

exports.getTechnology = function (req, res, next) {
    db.find("article",{"classify":"技术杂谈"},{"pageamount":10,"sort":{"date":-1}}, function (err, result) {
        if(err){
            console.log(err);
        }
        var obj = {"allResult" : result};
...
//Entertainment!
exports.showEntertainment = function (req, res, result) {
    res.render("Entertainment");
};

exports.getEntertainment = function (req, res, next) {
    db.find("article",{"classify":"娱乐"},{"pageamount":10,"sort":{"date":-1}}, function (err, result) {
        if(err){
            console.log(err);
        }
        var obj = {"allResult" : result};
